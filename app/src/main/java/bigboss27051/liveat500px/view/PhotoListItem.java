package bigboss27051.liveat500px.view;
...
public class PhotoListItem extends BaseCustomViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        int width = MeasureSpec.getSize(widthMeasureSpec);// int width px
        int heigth = width * 2 / 3;
        int newHeigthMeasureSpec = MeasureSpec.makeMeasureSpec(heigth, MeasureSpec.EXACTLY);
        //Child View
